...
The [document-based database](https://www.geeksforgeeks.org/dbms/document-databases-in-nosql/) is a nonrelational database. Instead of storing the data in rows and columns (tables), it uses the documents to store the data in the database. A document database stores data in JSON, BSON or [XML](https://www.geeksforgeeks.org/websites-apps/what-is-xml/) documents.
